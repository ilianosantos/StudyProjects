 ...
 */
private val NormalStates = listOf(TurtleState.SWIM_1, TurtleState.SWIM_2, TurtleState.SWIM_3, TurtleState.SWIM_2)
/**
 * Successive animation states of a diver turtle.
 */
private val DiverStates = listOf(TurtleState.SWIM_1,
    TurtleState.SWIM_2, TurtleState.SWIM_3, TurtleState.DIVE_1,
    TurtleState.DIVE_2, TurtleState.UNDER_WATER, TurtleState.DIVE_2,
    TurtleState.DIVE_1, TurtleState.SWIM_3, TurtleState.SWIM_2
)
/**
